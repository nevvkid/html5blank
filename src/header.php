...
<html <?php language_attributes(); ?> class="no-js">
    ...
    <meta name="twitter:image" content="<?php echo get_template_directory_uri(); ?>/img/page-landing/zedcon.jpg" />
    ...
    <meta property="og:image" content="<?php echo get_template_directory_uri(); ?>/img/page-landing/zedcon.jpg"/>
